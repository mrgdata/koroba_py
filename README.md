...
1. **104 cards** numbered 1–104, each worth 1–7 penalty points (randomly and exponentially distributed in each game round).
...
5. After **10 rounds** or after a player reaches **60 points**, the player with the **fewest** penalty points wins.
